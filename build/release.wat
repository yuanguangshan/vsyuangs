(module
 ...
 (func $export:src/engine/agent/governance/sandbox/core.as/evaluate (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $2
   i32.store offset=8
   block $__inlined_func$src/engine/agent/governance/sandbox/core.as/evaluate$122 (result i32)
    global.get $~lib/memory/__stack_pointer
    i32.const 8
    i32.sub
    global.set $~lib/memory/__stack_pointer
    ...
    if
     ...
     global.set $~lib/memory/__stack_pointer
     i32.const 1152
     br $__inlined_func$src/engine/agent/governance/sandbox/core.as/evaluate$122
    end
    global.get $~lib/memory/__stack_pointer
    local.get $2
    i32.store
